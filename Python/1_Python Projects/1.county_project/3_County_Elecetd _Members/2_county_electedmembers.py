#Home / Government / Elected Officials 1.content_County.txt','w Back to top
...
delimeter = "Home / Government / Elected Officials"
def clensing ():
    FH=open("1.content_County.txt",'r')
    Fhout = open('2.content_County.txt','a')
...
def clensing_leven2():
    ...
    Fhout = open('3.content_County.txt','w' )
    
    s = FH.read()
    delimeter2 = "Back to top"
...
def clensing():                                       # Function to Format the data 
	FH=open("3.content_County.txt",'r') 
	...
	str1=' '.join(student)
	FH.close()
	FH1 = open('4.content_County.txt','w+')
